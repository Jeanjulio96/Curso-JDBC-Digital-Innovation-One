...
public class ConnectionJDBC {
	...
	public static void main(String[] args) {
		...
		// (Como demonstrado na parte 1 do curso)
		...
		// partir da versão JDBC 4 não é mais necessário!!!)
		// Class.forName("com.mysql.jdbc.Driver");

		// 4 - Criar conexão usando o DriverManager, passando como parâmetros a string
		// de conexão, usuário e senha do usuário.
		try (Connection conn = DriverManager.getConnection(connectionUrl, "root", "J1e2a3N4")) {
